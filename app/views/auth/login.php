        ...
        <div class="md:flex w-full">
            ...
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10 flex flex-col justify-center">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-violet-600">Log In</h1>
                ...
                <form action="/login" method="post" class="space-y-6 ">
                    ...
                    <?php if(isset($emptyError)): ?>
                        <p class="text-red-500"><?php echo $emptyError; ?></p>
                    <?php endif; ?>
                    ...
                    <div>
                        <input type="password" name="password" id="password" placeholder="**********" 
                               class="w-full px-4 py-2 text-gray-700 bg-white rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-violet-600 focus:ring-opacity-50">
                        <?php if(isset($emptyError)):?>
                            <p class="text-red-500"><?= $emptyError ?></p>
                        <?php endif; ?>
                        <!-- password error -->
                        <?php if(isset($invalidPasswordError)):?>
                            <p class="text-red-500"><?= $invalidPasswordError ?></p>
                        <?php endif; ?>
                    </div>
                    <!-- not found errur -->
                    <?php if(isset($notFoundError)):?>
                            <p class="text-red-500"><?= $notFoundError ?></p>
                    <?php endif; ?>
